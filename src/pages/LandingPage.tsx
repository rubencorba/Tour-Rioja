...
export function LandingPage({ onEnter }: LandingPageProps) {
  return (
    <div className="relative h-full w-full overflow-hidden bg-ink">
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-end gap-6 px-6 pb-14 sm:justify-center sm:pb-0">
        <div className="w-full max-w-sm border border-brass/60 bg-paper/85 px-6 py-7 text-center shadow-[0_10px_40px_rgba(0,0,0,0.35)] sm:px-8 sm:py-9">
          ...
          <p className="mt-3 text-sm leading-relaxed text-ink-soft">
            ...
            estuvieras ahí. Empezá cruzando la puerta.
          </p>
